#!/usr/bin/env python3
"""
Import the Altamira Dashboard project and tasks to the kanban board API.
Requires the kanban app running (http://localhost:3004 UI, http://localhost:3005 API).

Usage:
  python scripts/kanban-import-altamira-dashboard.py
  python scripts/kanban-import-altamira-dashboard.py --api-url http://localhost:3005
"""
...
IMPORT_CSV = WORKSPACE / "outputs" / "kanban-altamira-dashboard-import.csv"
DEFAULT_API = "http://localhost:3005"


def main() -> int:
    ap = argparse.ArgumentParser(description="Import Altamira Dashboard project to kanban board via API.")
