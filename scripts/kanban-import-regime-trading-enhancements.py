#!/usr/bin/env python3
"""
Import the Regime Trading Enhancements project (6 tasks) to the kanban board API.
Requires the kanban app running (http://localhost:3004 UI, http://localhost:3005 API).

Usage:
  python scripts/kanban-import-regime-trading-enhancements.py
"""
...
IMPORT_CSV = WORKSPACE / "outputs" / "kanban-regime-trading-enhancements.csv"
DEFAULT_API = "http://localhost:3005"


def main() -> int:
    ap = argparse.ArgumentParser(description="Import Regime Trading Enhancements project to kanban board.")
