# Stock Score Report: GOOGL — Alphabet Inc.

**Generated:** 2026-02-23 16:05:07
...
| Metric | Score | Grade |
|--------|-------|-------|
| **Composite Score** | 50.89 | **C** |
| Quality Score | 89.36 | A+ |
| Growth Score | 30.52 | F |
| Value Score | 44.12 | D+ |
| Health Score | 86.66 | A+ |
| Shareholder Score | 3.79 | F |
...
- **P/S**: 9.41
- **FCF Yield**: 1.93%
- **P/E (current) | Fair P/E**: 28.7 | 35
- **Margin of Safety**: +18.0%

### Health Metrics
- **Current Ratio**: 2.01
- **Interest Coverage**: 903.26

### Shareholder Metrics
- **Dividend Yield**: 0.26%
- **Dividend Growth (YoY)**: N/A
- **Buyback Yield**: 1.21%
- **Debt Paydown (YoY)**: -182.9%
...
**HOLD / CONSIDER REDUCING** — Below-average score; monitor closely.
