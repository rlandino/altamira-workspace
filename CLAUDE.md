...
| `scripts/daily_market_recap.py` | Generate daily market recap and optionally send summary + Markdown to Telegram | `python3 scripts/daily_market_recap.py --send-telegram` |
