...
│   │   ├── daily-market-recap.md # /daily-market-recap — daily recap with Telegram delivery
...
**Purpose:** Generate a daily market recap and send its summary and Markdown report to Telegram.

Uses FMP for indices, VIX, movers, sectors, headlines, technical levels, and the next seven days of earnings. Writes `outputs/daily-market-recap-{DATE}.md`; run `python3 scripts/daily_market_recap.py --send-telegram`.
