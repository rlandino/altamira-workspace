...
| `scripts/jane_street_premarket_edge_analyzer.py` | Generate `/Jane-Street-pre-market-edge-analyzer` markdown and optionally send it to Telegram | `python scripts/jane_street_premarket_edge_analyzer.py --send-telegram --telegram-chat-id CHAT_ID` |
