...
| `scripts/daily_market_recap.py` | Generate a daily market recap markdown file and optionally send summary + document to Telegram | `python scripts/daily_market_recap.py --send-telegram` |
