...
| `scripts/jane_street_pre_market_edge_analyzer.py` | Generate the Jane Street pre-market edge report and optionally send it to Telegram | `python3 scripts/jane_street_pre_market_edge_analyzer.py --telegram` |
