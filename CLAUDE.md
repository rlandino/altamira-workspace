...
Runs `scripts/daily_market_recap.py --send-telegram`; uses FMP market data and Telegram bot credentials. Writes `outputs/daily-market-recap-{DATE}.md`.
...
| `scripts/daily_market_recap.py` | Generate daily market recap Markdown and optionally send summary + document to Telegram | `python scripts/daily_market_recap.py --send-telegram` |
