...
| `scripts/daily_market_recap.py` | Generate a daily market recap markdown file and send the summary/file to Telegram | `python3 scripts/daily_market_recap.py` (optional `--date YYYY-MM-DD`, `--no-send`, `--chat-id CHAT_ID`) |
