...
│   │   ├── daily-market-recap.md # /daily-market-recap — market recap with Telegram summary + Markdown delivery
...
**Purpose:** Generate Altamira Capital's daily market recap, write `outputs/daily-market-recap-{DATE}.md`, and send both the summary and Markdown document to Telegram.

Uses FMP quotes, biggest gainers/losers, sector snapshot with ETF fallback, S&P 500 technical levels, headlines, and earnings calendar. Run `python3 scripts/daily_market_recap.py --send-telegram`.
