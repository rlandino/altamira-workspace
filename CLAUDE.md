...
| `scripts/trade_idea_generator.py` | Generate portfolio/watchlist CSP and covered-call ideas; optionally send Telegram alert | `python3 scripts/trade_idea_generator.py --send-telegram` |
