...
│   │   ├── daily-market-recap.md # /daily-market-recap — end-of-day market recap with Telegram delivery
...
**Purpose:** Generate an end-of-day daily market recap and send both a concise summary and the markdown file to Telegram.

Runs `scripts/daily_market_recap.py`, using FMP quotes, sector snapshot, movers, headlines, S&P 500 technicals, and earnings calendar. Writes `outputs/daily-market-recap-{DATE}.md`; use `--send-telegram` for Telegram delivery.
