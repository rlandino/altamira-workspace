...
| `scripts/trade_idea_generator.py` | Generate portfolio/watchlist trade ideas and optionally send to Telegram | `python scripts/trade_idea_generator.py [--send-telegram --telegram-chat-id CHAT_ID]` |
